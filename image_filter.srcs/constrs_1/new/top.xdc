# PYNQ-Z2 Top-Level Non-Timing Constraints
#
# Ref:  UG912 - Vivado Design Suite Properties Reference Guide
#
# 2/26/2020 - 8/1/2025  RK
...
## LEDs
set_property -dict {PACKAGE_PIN R14  IOSTANDARD LVCMOS33  DRIVE 8  SLEW SLOW} [get_ports {leds_4bits_tri_o[0]}]
set_property -dict {PACKAGE_PIN P14  IOSTANDARD LVCMOS33  DRIVE 8  SLEW SLOW} [get_ports {leds_4bits_tri_o[1]}]
set_property -dict {PACKAGE_PIN N16  IOSTANDARD LVCMOS33  DRIVE 8  SLEW SLOW} [get_ports {leds_4bits_tri_o[2]}]
set_property -dict {PACKAGE_PIN M14  IOSTANDARD LVCMOS33  DRIVE 8  SLEW SLOW} [get_ports {leds_4bits_tri_o[3]}]

## RGBLEDs
set_property -dict {PACKAGE_PIN L15  IOSTANDARD LVCMOS33  DRIVE 8  SLEW SLOW} [get_ports { LD4_rgb_o[0] }];  # blue 
set_property -dict {PACKAGE_PIN G17  IOSTANDARD LVCMOS33  DRIVE 8  SLEW SLOW} [get_ports { LD4_rgb_o[1] }];  # green
set_property -dict {PACKAGE_PIN N15  IOSTANDARD LVCMOS33  DRIVE 8  SLEW SLOW} [get_ports { LD4_rgb_o[2] }];  # red

set_property -dict {PACKAGE_PIN G14  IOSTANDARD LVCMOS33  DRIVE 8  SLEW SLOW} [get_ports { LD5_rgb_o[0] }];  # blue
set_property -dict {PACKAGE_PIN L14  IOSTANDARD LVCMOS33  DRIVE 8  SLEW SLOW} [get_ports { LD5_rgb_o[1] }];  # green
set_property -dict {PACKAGE_PIN M15  IOSTANDARD LVCMOS33  DRIVE 8  SLEW SLOW} [get_ports { LD5_rgb_o[2] }];  # red
...
#set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports {pmoda_rpi_gpio_tri_io[0]}];  # PMODA.1  = RPI.7
#set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports {pmoda_rpi_gpio_tri_io[1]}];  # PMODA.2  = RPI.29
#set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports {pmoda_rpi_gpio_tri_io[2]}];  # PMODA.3  = RPI.27
#set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports {pmoda_rpi_gpio_tri_io[3]}];  # PMODA.4  = RPI.28
#set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {pmoda_rpi_gpio_tri_io[4]}];  # PMODA.7  = RPI.31
#set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {pmoda_rpi_gpio_tri_io[5]}];  # PMODA.8  = RPI.26
#set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {pmoda_rpi_gpio_tri_io[6]}];  # PMODA.9  = RPI.3
#set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports {pmoda_rpi_gpio_tri_io[7]}];  # PMODA.10 = RPI.5
#set_property PULLTYPE PULLUP [get_ports {pmoda_rpi_gpio_tri_io[2]}]
#set_property PULLTYPE PULLUP [get_ports {pmoda_rpi_gpio_tri_io[3]}]
#set_property PULLTYPE PULLUP [get_ports {pmoda_rpi_gpio_tri_io[6]}]
#set_property PULLTYPE PULLUP [get_ports {pmoda_rpi_gpio_tri_io[7]}]
set_property -dict {PACKAGE_PIN Y18  IOSTANDARD LVCMOS33  PULLTYPE PULLUP} [get_ports {debug_rx}];  # PMODA.1  = RPI.7
set_property -dict {PACKAGE_PIN Y19  IOSTANDARD LVCMOS33}                  [get_ports {debug_tx}];  # PMODA.2  = RPI.29
...
#set_property PULLTYPE PULLUP [get_ports {pmodb_gpio_tri_io[2]}]
#set_property PULLTYPE PULLUP [get_ports {pmodb_gpio_tri_io[3]}]
#set_property PULLTYPE PULLUP [get_ports {pmodb_gpio_tri_io[6]}]
#set_property PULLTYPE PULLUP [get_ports {pmodb_gpio_tri_io[7]}]
...
## Arduino GPIO
# (If necessary, include DRIVE, SLEW, and PULLUP properties, i.e.:  DRIVE 16  SLEW FAST  PULLTYPE PULLUP)
#set_property -dict {PACKAGE_PIN Y13  IOSTANDARD LVCMOS33} [get_ports ARA]
#set_property -dict {PACKAGE_PIN T14  IOSTANDARD LVCMOS33} [get_ports AR0]
#set_property -dict {PACKAGE_PIN U12  IOSTANDARD LVCMOS33} [get_ports AR1]
...
#set_property -dict {PACKAGE_PIN V15  IOSTANDARD LVCMOS33  PULLTYPE PULLUP} [get_ports AR4]
...
#set_property -dict {PACKAGE_PIN N17  IOSTANDARD LVCMOS33} [get_ports AR13]
#set_property -dict {PACKAGE_PIN Y11  IOSTANDARD LVCMOS33} [get_ports {AR_A[0]}]
#set_property -dict {PACKAGE_PIN Y12  IOSTANDARD LVCMOS33} [get_ports {AR_A[1]}]
#set_property -dict {PACKAGE_PIN W11  IOSTANDARD LVCMOS33} [get_ports {AR_A[2]}]
#set_property -dict {PACKAGE_PIN V11  IOSTANDARD LVCMOS33} [get_ports {AR_A[3]}]
#set_property -dict {PACKAGE_PIN T5   IOSTANDARD LVCMOS33} [get_ports {AR_A[4]}]
#set_property -dict {PACKAGE_PIN U10  IOSTANDARD LVCMOS33} [get_ports {AR_A[5]}]
...
#set_property PULLTYPE PULLUP [get_ports arduino_direct_iic_scl_io]
#set_property PULLTYPE PULLUP [get_ports arduino_direct_iic_sda_io]
